...
//    xhr.send();
    ...
    xhr.onreadystatechange = function(){
        if (xhr.readyState === XMLHttpRequest.HEADERS_RECEIVED) {
            ...
            backend.getCookie = cookieHash+"="+userNameText
...
//    console.log(cookieName)
    var cookieName = cookieName.split('=')
    var md5_str = md5(cookieName[0] + cookieName[1] + "069bcd26e")
//    console.log(cookieName)
//    console.log(cookieName + cookieName[1] + "069bcd26e", md5(cookieName[0] + cookieName[1] + "069bcd26e"))

    var xhr = new XMLHttpRequest();

    xhr.open("POST", serverHost+"test.php");
    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
    xhr.send("cookieName=1&login="+cookieName[1]+"&md5_str="+md5_str);
